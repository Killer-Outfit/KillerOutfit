...
public class Map : MonoBehaviour
{
    ...
    private void SpawnWave(GameObject[] arr)
    {
        ...
        if (arr[1] != null) { Instantiate(arr[1], new Vector3(pT.position.x - 10, -2, -4), arr[1].transform.rotation); }
        if (arr[2] != null) { Instantiate(arr[2], new Vector3(pT.position.x - 10, -4, -6), arr[2].transform.rotation); }
